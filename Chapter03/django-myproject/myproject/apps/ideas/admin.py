...
from myproject.apps.core.admin import LanguageChoicesForm, get_multilingual_field_names
...
class IdeaAdmin(admin.ModelAdmin):
  ...
  fieldsets = [
    (_("Author and Category"), {"fields": ["author", "categories"]}), (_("Title and Content"),
